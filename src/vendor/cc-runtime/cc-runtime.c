...
UNUSED
static inline du_int udiv128by64to64default(du_int u1, du_int u0, du_int v, du_int* r) {
    const unsigned n_udword_bits = sizeof(du_int) * CHAR_BIT;
...
static inline du_int udiv128by64to64(du_int u1, du_int u0, du_int v, du_int* r) {
...
COMPILER_RT_ABI tu_int __udivmodti4(tu_int a, tu_int b, tu_int* rem) {
    ...
    if (divisor.s.high == 0) {
        ...
        if (dividend.s.high < divisor.s.low) {
            ...
            quotient.s.low = udiv128by64to64(dividend.s.high, dividend.s.low, divisor.s.low, &remainder.s.low);
            quotient.s.high = 0;
        } else {
