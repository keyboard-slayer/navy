...
struct limine_flanterm_fb_init_params_response {
    ...
    LIMINE_PTR(struct limine_flanterm_fb_init_params**)
    entries;
};
...
struct limine_flanterm_fb_init_params_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct limine_flanterm_fb_init_params_response*)
    response;
};
...
struct limine_mp_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct limine_mp_response*)
    response;
    uint64_t flags;
};
...
struct limine_tpm_event_log_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct limine_tpm_event_log_response*)
    response;
};
...
struct limine_x86_64_keep_iommu_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct limine_x86_64_keep_iommu_response*)
    response;
};
...
struct limine_tsc_frequency_request {
    uint64_t id[4];
    uint64_t revision;
    LIMINE_PTR(struct limine_tsc_frequency_response*)
    response;
};
